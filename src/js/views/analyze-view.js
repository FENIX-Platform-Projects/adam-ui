...
define([
    ...
    'fx-ds/start',
    'fx-filter/start',
    'text!templates/analyze/analyze.hbs',
    'text!templates/analyze/dashboard.hbs',
    ...
    var AnalyzeView = View.extend({
        ...
        attach: function () {
            ...
            this.analyze_type ? this._showFludeTopic(this.analyze_type) :  this._displayAnalyzeOptions() ;
        },
        ...
        _showFludeTopic: function (topic) {
           console.log("_showFludeTopic topric = "+topic);
        ...
        _renderFludeComponents: function (topic) {
            console.log("_renderFludeComponents topric = "+topic);
