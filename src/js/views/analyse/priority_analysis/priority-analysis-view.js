...
define([
    ...
    'views/analyse/priority_analysis/dashboard-table-view',
    ...
    var s = {
        css_classes: {
            TITLE_BAR_ITEMS: "#analyse-priority-analysis-fx-title-items",
            FILTER_HOLDER: "#analyse-priority-analysis-filter-holder",
            DASHBOARD_CHARTS_HOLDER: "#analyse-priority-analysis-charts-content",
            DASHBOARD_TABLE_HOLDER: "#analyse-priority-analysis-table-content"
        },
        dashboardModel: {
            LABEL: 'label'
        },
        paths: {
          ...
          TABLE_CONFIG: 'config/analyse/priority_analysis/config-table'
        }
    };
     ...
     * Resource Priority Analysis View comprises of a series of subviews: title view, filter view and 2 dashboard views (charts dashboard and table dashboard)
    ...
    var PriorityAnalysisView = View.extend({
        ...
        _loadConfigurations: function () {
            require([s.paths.CHARTS_CONFIG, s.paths.TABLE_CONFIG], _.bind(this._initSubViews, this));
        },
        ...
        _getDashboardConfiguration: function (filterDerivedTopic, filterValues) {
            ...
            if (filterDerivedTopic && filterDerivedTopic !== this.topic) {
                ...
                require([s.paths.CHARTS_CONFIG, s.paths.TABLE_CONFIG], function (TopicChartsConfig, TopicTableConfig) {
